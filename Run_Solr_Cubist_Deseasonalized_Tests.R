      ...
      for(hour in 0:23) {
        ...
        if(nrow(test_data) > 0 && nrow(training_data) > 0) {
          if(!is.null(P_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            SCBH1_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["columns"]] <- as.vector(goodCorrelateTop(training_data, "SOLR_6", num_features, results=P_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])[["names"]])
          ...
          if(!is.null(S_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            SCBH1_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["columns"]] <- as.vector(goodCorrelateTop(training_data, "SOLR_6", num_features, results=S_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])[["names"]])
          ...
          if(!is.null(K_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            SCBH1_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["columns"]] <- as.vector(goodCorrelateTop(training_data, "SOLR_6", num_features, results=K_Deseasonalized_Solr[[as.character(pentad)]][[as.character(hour)]])[["names"]])
