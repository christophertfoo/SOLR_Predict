  ...
  for(test_year in 2010:2013) {
    ...
    for(pentad in 1:num_groups) {
      ...
      for(hour in 0:23) {
        ...
        writeLines(paste("Start", start, "End", end))
        if(nrow(training_data) > 0 && nrow(test_data) > 0) {
          if(!is.null(P_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            Station_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=P_Solr[[as.character(pentad)]][[as.character(hour)]])
            #        writeLines(paste("    ", Station_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
            Station_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["model"]] <- lm(formula=as.formula(Station_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]), data=training_data, na.action=na.omit)
          ...
          if(!is.null(S_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            Station_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=S_Solr[[as.character(pentad)]][[as.character(hour)]])
            #        writeLines(paste("    ", Station_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
            Station_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["model"]] <- lm(formula=as.formula(Station_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]), data=training_data, na.action=na.omit)
          ...
          if(!is.null(K_Solr[[as.character(pentad)]][[as.character(hour)]])) {
            ...
            Station_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=K_Solr[[as.character(pentad)]][[as.character(hour)]])
            #        writeLines(paste("    ", Station_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
            Station_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["model"]] <- lm(formula=as.formula(Station_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]), data=training_data, na.action=na.omit)
...
save(result, file="Solr_Results.RData")