    ...
    for(pentad in 1:num_groups) {
      ...
      for(hour in 0:23) {
        ...
        if(!is.null(P_Solr[[as.character(pentad)]][[as.character(hour)]])) {
          ...
          SCBH1_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=P_Solr[[as.character(pentad)]][[as.character(hour)]])
          #        writeLines(paste("    ", SCBH1_P_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
        ...
        if(!is.null(S_Solr[[as.character(pentad)]][[as.character(hour)]])) {
          ...
          SCBH1_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=S_Solr[[as.character(pentad)]][[as.character(hour)]])
          #        writeLines(paste("    ", SCBH1_S_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
        ...
        if(!is.null(K_Solr[[as.character(pentad)]][[as.character(hour)]])) {
          ...
          SCBH1_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]] <- makeTopFunction(training_data, "SOLR_6", num_features, correlationResults=K_Solr[[as.character(pentad)]][[as.character(hour)]])
          #        writeLines(paste("    ", SCBH1_K_Solr[[as.character(pentad)]][[as.character(hour)]][[as.character(test_year)]][["function"]]))
