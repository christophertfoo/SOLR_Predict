...
# 0 Neighbors
#  function_string <- paste("SOLR_6 ~ ", paste("SOLR_4", "SOLR_3", "RELH_4", "RELH_3", "TMPF_4", "TMPF_3", "SKNT_4", "SKNT_3", "DRCT_4", "DRCT_3", sep="+"), sep="")

# Q1 - 1 Neighbor
# function_string <- paste("SOLR_6 ~ ", paste("SOLR_4", "SOLR_3", "RELH_4", "RELH_3", "TMPF_4", "TMPF_3", "SKNT_4", "SKNT_3", "DRCT_4", "DRCT_3", "KTAH1_SOLR_4", "KTAH1_SOLR_3", "KTAH1_RELH_4", "KTAH1_RELH_3", "KTAH1_TMPF_4", "KTAH1_TMPF_3", "KTAH1_SKNT_4", "KTAH1_SKNT_3", "KTAH1_DRCT_4", "KTAH1_DRCT_3", sep="+"), sep="")

# Q2 - 1 Neighbor
# function_string <- paste("SOLR_6 ~ ", paste("SOLR_4", "SOLR_3", "RELH_4", "RELH_3", "TMPF_4", "TMPF_3", "SKNT_4", "SKNT_3", "DRCT_4", "DRCT_3", "PHHI_RELH_4", "PHHI_RELH_3", "PHHI_TMPF_4", "PHHI_TMPF_3", "PHHI_SKNT_4", "PHHI_SKNT_3", "PHHI_DRCT_4", "PHHI_DRCT_3", sep="+"), sep="")

# Q3 - 1 Neighbor
# function_string <- paste("SOLR_6 ~ ", paste("SOLR_4", "SOLR_3", "RELH_4", "RELH_3", "TMPF_4", "TMPF_3", "SKNT_4", "SKNT_3", "DRCT_4", "DRCT_3", "SCSH1_SOLR_4", "SCSH1_SOLR_3", "SCSH1_RELH_4", "SCSH1_RELH_3", "SCSH1_TMPF_4", "SCSH1_TMPF_3", "SCSH1_SKNT_4", "SCSH1_SKNT_3", "SCSH1_DRCT_4", "SCSH1_DRCT_3", sep="+"), sep="")

# Q4 - 1 Neighbor
# function_string <- paste("SOLR_6 ~ ", paste("SOLR_4", "SOLR_3", "RELH_4", "RELH_3", "TMPF_4", "TMPF_3", "SKNT_4", "SKNT_3", "DRCT_4", "DRCT_3", "MKRH1_SOLR_4", "MKRH1_SOLR_3", "MKRH1_RELH_4", "MKRH1_RELH_3", "MKRH1_TMPF_4", "MKRH1_TMPF_3", "MKRH1_SKNT_4", "MKRH1_SKNT_3", "MKRH1_DRCT_4", "MKRH1_DRCT_3", sep="+"), sep="")
